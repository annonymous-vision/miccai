...
# BB
##########################################
python Path/PhD/miccai/codebase/train_BB_mimic_cxr.py \
  --arch='densenet121' \
  --workers=5 \
  --epochs=60 \
  --start-epoch=0 \
...
# t
##########################################
python Path/PhD/miccai/codebase/train_t_mimic_cxr.py \
  --arch='densenet121' \
  --workers=5 \
  --epochs=60 \
  --start-epoch=0 \
...
python Path/PhD/miccai/codebase/test_t_mimic_cxr.py \
  --arch='densenet121' \
  --workers=5 \
  --epochs=60 \
  --start-epoch=0 \
...
python Path/PhD/miccai/codebase/train_explainer_mimic_cxr.py \
  --iter 1 \
  --with_seed "y" \
...
python Path/PhD/miccai/codebase/test_explainer_mimic_cxr.py \
  --iter 1 \
  --with_seed "y" \
  --expert-to-train "explainer" \
  --dataset "mimic_cxr" \
...
python Path/PhD/miccai/codebase/FOLs_mimic_cxr_main.py --iteration 1 --disease "pneumothorax" --model "MoIE" >$slurm_fol_g_1
...
python Path/PhD/miccai/codebase/FOLs_mimic_cxr_main.py --iteration 2 --disease "pneumothorax" --model "MoIE" >$slurm_fol_g_2
...
python Path/PhD/miccai/codebase/FOLs_mimic_cxr_main.py --iteration 3 --disease "pneumothorax" --model "MoIE"
...
python Path/PhD/miccai/codebase/FOLs_mimic_cxr_main.py --iteration 4 --disease "pneumothorax" --model "MoIE" >$slurm_fol_g_4
...
python Path/PhD/miccai/codebase/FOLs_mimic_cxr_main.py --iteration 5 --disease "pneumothorax" --model "MoIE" >$slurm_fol_g_5
...
# All Performance
python Path/PhD/miccai/codebase/performance_calculation_mimic_cxr_main.py --iterations 5 --disease "pneumothorax" --model "MoIE" >$slurm_all_perf

# Residual vs BB
python Path/PhD/miccai/codebase/performance_calculation_mimic_cxr_residual_main.py --iterations 5 --disease "pneumothorax" --model "MoIE">$slurm_res_v_BB
