...
python Path/PhD/miccai/codebase/FOLs_mimic_cxr_main.py --iteration 1 --disease "pneumonia" --model "MoIE" >$slurm_fol_g_1
...
python Path/PhD/miccai/codebase/FOLs_mimic_cxr_main.py --iteration 2 --disease "pneumonia" --model "MoIE" >$slurm_fol_g_2
...
python Path/PhD/miccai/codebase/FOLs_mimic_cxr_main.py --iteration 3 --disease "pneumonia" --model "MoIE" >$slurm_fol_g_3
...
python Path/PhD/miccai/codebase/FOLs_mimic_cxr_main.py --iteration 4 --disease "pneumonia" --model "MoIE" >$slurm_fol_g_4
...
# All Performance
python Path/PhD/miccai/codebase/performance_calculation_mimic_cxr_main.py --iterations 4 --disease "pneumonia" --model "MoIE" >$slurm_all_perf

# Residual vs BB
python Path/PhD/miccai/codebase/performance_calculation_mimic_cxr_residual_main.py --iterations 4 --disease "pneumonia" --model "MoIE" >$slurm_res_v_BB
