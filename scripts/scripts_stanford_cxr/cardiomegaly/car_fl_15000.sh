...
python /ocean/projects/asc170022p/shg121/PhD/ICLR-2022/codebase/cal_flops_cxr_domain_transfer_main.py \
  --disease "cardiomegaly" \
  --tot_samples 15000 \
  --batch-size 64 \
  --epochs 5 --profile "y" >$slurm_output_moie

python /ocean/projects/asc170022p/shg121/PhD/ICLR-2022/codebase/train_BB_stanford_cxr.py --arch='densenet121' --selected-obs="cardiomegaly" --epochs 1 --labels "0 (No cardiomegaly)" "1 (cardiomegaly)"  --domain_transfer "y" --tot_samples 15000 --checkpoint-mimic-cxr "g_best_model_epoch_1.pth.tar" --profile "y" >$slurm_output_BB
