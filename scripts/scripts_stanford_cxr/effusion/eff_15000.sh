...
python Path/PhD/miccai/codebase/train_BB_stanford_cxr.py --arch='densenet121' --selected-obs="effusion" --epochs 5 --labels "0 (No effusion)" "1 (effusion)"  --domain_transfer "y" --tot_samples 15000 --checkpoint-mimic-cxr "g_best_model_epoch_3.pth.tar" >$slurm_output_bb
...
python Path/PhD/miccai/codebase/performance_calculation_cxr_domain_transfer_main.py --iterations 3 --disease "effusion" --model "MoIE" --tot_samples 15000 --cov 0.4 0.3 0.3 --initialize_w_mimic "y"  > $slurm_output_total
