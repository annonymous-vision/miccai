...
parser.add_argument('--epochs-residual', type=int, default=15, help='batch size for training the residual')
...
parser.add_argument('--disease_folder', default='cardiomegaly', type=str, metavar='N', help='which disease type?')
